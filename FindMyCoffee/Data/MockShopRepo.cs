...
namespace FindMyCoffee.Data
{
    public class MockShopRepo : IFindMyCoffeeRepo
    {
        ...
        public CoffeeShopEntity GetShopById(int id)
        {
            ...
            return new CoffeeShopEntity { Id = 1, Name = "LaKitty", Type = "Cat coffee shop", Title = "Pet a cat and get fat!", Latitude = 2.1, Longitude = 3.2, IsOpen = true };
        }
        ...
        public IEnumerable<CoffeeShopEntity> GetWebShopInfo()
        {
            ...
            {
                new CoffeeShopEntity { Id = 1, Name = "LaKitty", Type = "Cat coffee shop", Title = "Pet a cat and get fat!", Latitude = 2.1, Longitude = 3.2, IsOpen = true },
                new CoffeeShopEntity { Id = 2, Name = "Larc-En-Ciel", Type = "Bakery", Title = "Baking your cake!", Latitude = 2.3, Longitude = 3.4, IsOpen = false }
            };
